...
def set_all_entrance_rules(world: TeardownWorld) -> None:
    ...
    if world.options.ToolUpgrades:
        ...
        world.set_rule(menu_to_heavylifting,        Has("Heavy Lifting Unlock") &           HasGroup("Wall/Opening", count=1) & HasGroup("Plank/Cable", count=1))
        world.set_rule(menu_to_tower,               Has("The Tower Unlock"))
        world.set_rule(menu_to_finearts,            Has("Fine Arts Unlock"))
        world.set_rule(menu_to_toolup,              Has("Tool Up Unlock") &                (HasGroup("Wall/Opening", count=1) | HasGroup("Destruction", count=1)) & HasGroup("Plank/Cable", count=1))
        ...
        world.set_rule(menu_to_insurancefraud,      Has("Insurance Fraud Unlock") &         HasGroup("Plank/Cable", count=1))
        ...
        world.set_rule(menu_to_wetaffair,           Has("A Wet Affair Unlock") &            HasGroup("Door", count=1) &         HasGroup("Wall/Opening", count=1))
        world.set_rule(menu_to_poweroutage,         Has("Power Outage Unlock") &            HasGroup("Wall/Opening", count=1) & HasGroup("Guns", count=2))
        world.set_rule(menu_to_motivationalreminder, Has("Motivational Reminder Unlock") &  HasGroup("Wall/Opening", count=1) & HasGroup("Destruction", count=1) &  HasGroup("Guns", count=1))
        world.set_rule(menu_to_assortmentofdishes,  Has("An Assortment Of Dishes Unlock") & HasGroup("Door", count=1) &         HasGroup("Wall/Opening", count=2) & HasGroup("Destruction", count=1))
        world.set_rule(menu_to_flooding,            Has("Flooding Unlock") &                HasGroup("Wall/Opening", count=1) & Has("Plank Unlock") &               Has("Plank Max Length Upgrade", count=1) & Has("Plank Amount Upgrade", count=1))
        world.set_rule(menu_to_chase,               Has("The Chase Unlock"))
        world.set_rule(menu_to_roborazzi,           Has("Roborazzi Unlock"))
        world.set_rule(menu_to_secretingredients,   Has("The Secret Ingredients Unlock") &  HasGroup("Door", count=1) &         HasGroup("Wall/Opening", count=1) & HasGroup("Destruction", count=2))   #
        ...
        world.set_rule(menu_to_quileztools,         Has("The Quilez Tools Unlock") &        HasGroup("Wall/Opening", count=2) & HasGroup("Destruction", count=1)&   Has("Plank Unlock") & Has("Plank Amount Upgrade", count=1))
        world.set_rule(menu_to_connectingthedots,   Has("Connecting The Dots Unlock") &     HasGroup("Wall/Opening", count=2) & HasGroup("Destruction", count=3))
        world.set_rule(menu_to_pawnshop,            Has("The Pawn Shop Unlock") &           HasGroup("Wall/Opening", count=2) & Has("Plank Unlock"))
        world.set_rule(menu_to_droidabduction,      Has("The Droid Abduction Unlock") &     HasGroup("Wall/Opening", count=2) & HasGroup("Destruction", count=2))
        world.set_rule(menu_to_maliceinwoonderland, Has("Malice In Woonderland Unlock") &   HasGroup("Destruction", count=3) & HasGroup("Guns", count=1) & Has("Nitroglycerin Unlock")& Has("Nitroglycerin Rounds Upgrade", count=2))
        world.set_rule(menu_to_handlewithcare,      Has("Handle With Care Unlock") &        HasGroup("Wall/Opening", count=2) & HasGroup("Destruction", count=1) & Has ("Rocket Launcher Unlock") & Has ("Rocket Launcher Rounds Upgrade", count=2))
        ...
        world.set_rule(menu_to_motivationalreminder, Has("Motivational Reminder Unlock") &  HasGroup("Wall/Opening", count=1) & HasGroup("Destruction", count=1) &  HasGroup("Guns", count=1))
        world.set_rule(menu_to_assortmentofdishes,  Has("An Assortment Of Dishes Unlock") & HasGroup("Door", count=1) &         HasGroup("Wall/Opening", count=2) & HasGroup("Destruction", count=1))
        world.set_rule(menu_to_flooding,            Has("Flooding Unlock") &                HasGroup("Wall/Opening", count=1) & Has("Plank Unlock"))
        world.set_rule(menu_to_chase,               Has("The Chase Unlock"))
        world.set_rule(menu_to_roborazzi,           Has("Roborazzi Unlock"))
        world.set_rule(menu_to_secretingredients,   Has("The Secret Ingredients Unlock") &  HasGroup("Door", count=1) &         HasGroup("Wall/Opening", count=1) & HasGroup("Destruction", count=2))   #
        world.set_rule(menu_to_bluetideshortage,    Has("The BlueTide Shortage Unlock") &   HasGroup("Wall/Opening", count=1) & HasGroup("Plank/Cable", count=1))                                       #
        ...
        world.set_rule(menu_to_ornamentordeal,      Has("Ornament Ordeal Unlock") &         HasGroup("Wall/Opening", count=3) & HasGroup("Guns", count=1))
        world.set_rule(menu_to_quileztools,         Has("The Quilez Tools Unlock") &        HasGroup("Wall/Opening", count=2) & HasGroup("Destruction", count=1)&   Has("Plank Unlock"))
        world.set_rule(menu_to_connectingthedots,   Has("Connecting The Dots Unlock") &     HasGroup("Wall/Opening", count=2) & HasGroup("Destruction", count=3))
        world.set_rule(menu_to_pawnshop,            Has("The Pawn Shop Unlock") &           HasGroup("Wall/Opening", count=2) & Has("Plank Unlock"))
        world.set_rule(menu_to_droidabduction,      Has("The Droid Abduction Unlock") &     HasGroup("Wall/Opening", count=2) & HasGroup("Destruction", count=2))
        world.set_rule(menu_to_maliceinwoonderland, Has("Malice In Woonderland Unlock") &   HasGroup("Destruction", count=3) & HasGroup("Guns", count=1) & Has("Nitroglycerin Unlock"))
        world.set_rule(menu_to_handlewithcare,      Has("Handle With Care Unlock") &        HasGroup("Wall/Opening", count=2) & HasGroup("Destruction", count=1) & Has ("Rocket Launcher Unlock"))
